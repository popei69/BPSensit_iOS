...
// Numerics
CGFloat const kJBLineChartFooterViewSeparatorWidth = 1.0f;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _leftLabel.font = [UIFont fontWithName:@"Avenir" size:12];
        ...
        _rightLabel.font = [UIFont fontWithName:@"Avenir" size:12];
